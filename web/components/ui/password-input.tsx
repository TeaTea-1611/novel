  ...
  return (
    <div className={"relative"}>
      <input
        ...
        className={cn(
          "peer pl-2 pr-10 pb-2 pt-6 block h-11 w-full rounded-md bg-background shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 hide-password-toggle",
          className,
        )}
        placeholder=" "
        {...props}
