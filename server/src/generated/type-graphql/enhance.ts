...
const modelsInfo = {
  User: ["id", "nickname", "email", "phone", "avatar", "pendant", "role", "gender", "introduce", "dob", "urls", "keyNum", "ticketNum", "candyNum", "createdAt", "emailVerified", "isTwoFactorEnable"],
  RefreshToken: ["id", "userId", "token", "expires"],
