...
@Service()
@Resolver()
export class AppContentResolver {
  ...
  private async readFile(fileName: keyof typeof AppContentResolver.fileMap) {
    const filePath = path.join(
      import.meta.dir,
      AppContentResolver.fileMap[fileName],
    );
  ...
  private async writeFile(
    fileName: keyof typeof AppContentResolver.fileMap,
    value: string,
  ) {
    const filePath = path.join(
      import.meta.dir,
