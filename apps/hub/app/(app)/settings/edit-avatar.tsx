...
export const EditAvatar = ({ avatar, onSave }: Props) => {
  ...
  return (
    ...
    >
      <div className="relative z-10 p-0.5 shadow-md rounded-xl group size-28 bg-background">
        <input
          id="update-avatar"
          type="file"
          accept="image/*"
          ...
          className="hidden"
        />
        <UserAvatar avatar={avatar} className="size-full" />
        <label
