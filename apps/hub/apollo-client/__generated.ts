...
export type ChangeAvatarCoverMutation = { __typename?: 'Mutation', changeAvatarCover: { __typename?: 'User', id: number, email: string, nickname: string, avatar: string, avatarCover: string, role: UserRole, emailVerified?: any | null, isTwoFactorEnable: boolean, gender: number, introduce: string, phone: string, dob: any, urls: Array<string>, keyNum: number, ticketNum: number, candyNum: number, createdAt: any } };
...
export type CreatedBooksQuery = { __typename?: 'Query', createdBooks: { __typename?: 'PaginatedBooksResponse', total: number, prev?: number | null, next?: number | null, totalPages: number, books: Array<{ __typename?: 'Book', id: number, name: string, originalName: string, synopsis: string, poster: string, kind: number, gender: number, status: number, wordCnt: number, flowerCnt: number, readCnt: number, reviewCnt: number, chapterCnt: number, commentCnt: number, points: number, createdAt: any, newChapterAt: any, author?: { __typename?: 'Author', id: number, name: string, originalName: string } | null, createdBy: { __typename?: 'User', id: number, nickname: string, avatar: string, avatarCover: string }, tags: Array<{ __typename?: 'Tag', id: number, name: string, group: { __typename?: 'TagGroup', name: string, color: string } }>, genre: { __typename?: 'Genre', id: number, name: string } }> } };
...
export type MutationTagMutation = { __typename?: 'Mutation', mutationTag: { __typename?: 'Tag', id: number, groupId: number, name: string, group: { __typename?: 'TagGroup', id: number, name: string, color: string } } };
...
export const ChangeAvatarCoverDocument = gql`
  ...
  changeAvatarCover(avatarCover: $avatarCover) {
    ...
    ${UserFragmentDoc}`;
export type ChangeAvatarCoverMutationFn = Apollo.MutationFunction<ChangeAvatarCoverMutation, ChangeAvatarCoverMutationVariables>;
 ...
 * });
 */
export function useChangeAvatarCoverMutation(baseOptions?: Apollo.MutationHookOptions<ChangeAvatarCoverMutation, ChangeAvatarCoverMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeAvatarCoverMutation, ChangeAvatarCoverMutationVariables>(ChangeAvatarCoverDocument, options);
      }
export type ChangeAvatarCoverMutationHookResult = ReturnType<typeof useChangeAvatarCoverMutation>;
export type ChangeAvatarCoverMutationResult = Apollo.MutationResult<ChangeAvatarCoverMutation>;
export type ChangeAvatarCoverMutationOptions = Apollo.BaseMutationOptions<ChangeAvatarCoverMutation, ChangeAvatarCoverMutationVariables>;
 ...
 * });
 */
export function useHomePageDataQuery(baseOptions: Apollo.QueryHookOptions<HomePageDataQuery, HomePageDataQueryVariables> & ({ variables: HomePageDataQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export const CreatedBooksDocument = gql`
    query CreatedBooks($page: Int!, $take: Int!, $keyword: String!, $gender: Int, $genreId: Int, $tagIds: [Int!], $sortBy: String, $sortOrder: SortOrder) {
  createdBooks(
    page: $page
    take: $take
    keyword: $keyword
...
export const MutationTagDocument = gql`
    mutation MutationTag($groupId: Int!, $name: String!, $tagId: Int) {
  mutationTag(groupId: $groupId, name: $name, tagId: $tagId) {
    id
    groupId
    name
    group {
