  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className="p-0 rounded-tl-lg rounded-bl-lg">
        <SheetClose
          className={cn(
            "absolute top-1 right-1 z-50 backdrop-blur-[2px] size-6 flex items-center justify-center rounded-lg hover:backdrop-blur-sm",
          )}
        >
          <X className="size-3" />
        ...
        <SheetHeader className="relative">
          <div className="flex flex-col">
            <div className="relative">
              <div className="absolute inset-0 overflow-hidden -z-10 rounded-xl bg-accent">
                {!!data.me.avatarCover && (
                  <UserAvatar
              ...
              <div className="p-1 shadow-md size-28 rounded-xl bg-background">
            ...
            <div className="grid flex-1 p-4 ml-2 leading-tight text-left">
              ...
              <span className="text-xs truncate">{data.me.email}</span>
            </div>
          </div>
          <VisuallyHidden>
            <SheetTitle />
