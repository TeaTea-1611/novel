...
import { CurrentStreakButton } from "./current-straek-button";
...
export const MainHeader = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full h-16 gap-2 px-4 lg:px-10 md:gap-4">
        ...
        <Separator orientation="vertical" className="hidden h-4 md:block" />
        <div className="flex items-center p-1 space-x-2 md:space-x-2 bg-primary/10 rounded-xl">
          <CurrentStreakButton />
          <UserButton />
        </div>
      </div>
