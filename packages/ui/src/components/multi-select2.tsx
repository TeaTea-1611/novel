...
interface MultiSelectorProps
  ...
  options?: TagOption[]; // Add options to store color information
  loop?: boolean;
}
  ...
  return (
    ...
    >
      {value.map((item, index) => {
        const itemOption = options?.find((opt) => opt.value === item);
        return (
          <Badge
            key={item}
            className={cn(
            ...
            style={{
              backgroundColor: itemOption?.bgColor,
...
>(({ className, value, children, color, bgColor, ...props }, ref) => {
